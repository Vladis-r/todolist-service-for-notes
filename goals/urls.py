...
urlpatterns = [
    ...
    path("goal/goal_comment/create", views.GoalCommentCreateView.as_view()),
    path("goal/goal_comment/list", views.GoalCommentListView.as_view()),
    path("goal/goal_comment/<pk>", views.GoalCommentView.as_view()),
]
